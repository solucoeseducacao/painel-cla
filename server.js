...
// Log de uso (prova de prompt-cache nos logs do Render): cache_r>0 ⇒ PDFs reaproveitados.
(function(){const _create=client.messages.create.bind(client.messages);client.messages.create=async function(opts){const res=await _create(opts);try{const u=(res&&res.usage)||{};console.log('[uso]',opts&&opts.model,JSON.stringify({in:u.input_tokens,out:u.output_tokens,cache_w:u.cache_creation_input_tokens||0,cache_r:u.cache_read_input_tokens||0}));}catch(_){}return res;};})();
